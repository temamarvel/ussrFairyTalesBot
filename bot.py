...
def echo(update, context):
    ...
    url = s3.generate_presigned_url("get_object", Params={"Bucket": "botdatabucket", "Key": "Волшебная лампа Алладина/alladin.jpg"}, ExpiresIn=100)
    ...
    url = s3.generate_presigned_url("get_object", Params={"Bucket": "botdatabucket", "Key": "Волшебная лампа Алладина/Волшебная лампа Алладина.mp3"}, ExpiresIn=100)
